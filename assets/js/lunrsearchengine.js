...
var documents = [{
    ...
    "url": "/",
    "title": "Home",
    "body": "123456789101112131415&lt;section class= featured-posts &gt;  &lt;div class= section-title &gt;    &lt;h2&gt;&lt;span&gt;Destaques&lt;/span&gt;&lt;/h2&gt;  &lt;/div&gt;  &lt;div class= row &gt;                  &lt;!-- begin post --&gt;                                                                                                                                                                                                        Pedra de Roseta - 5 minutos de História                              :               A série 5 minutos de história de hoje está imperdível! Vamos falar sobre um tesouro deixado pela civilização egípcia: a Pedra de Roseta. Embarque nessa. . . :                                                                                                                                                                       João Messias                                27/04/2020                                                                                                        1      &lt;!-- begin post --&gt;                                                                                                                                                                                                        Let's test spoilers                              :               Director Roland Suso Richter’s enigmatic psychological thriller (direct to video/DVD) was based upon screenwriter Michael Cooney’s own play “Point of Death” - a title that. . . :                                                                                                                                                                       João Messias                                11/01/2018                                                                                                        1      &lt;!-- begin post --&gt;                                                                                                                                                                                                        Inception Movie                                                 1 2 3 4 5                                              :               Review products, books, movies, restaurant and anything you like on your Jekyll blog with Mediumish! JSON-LD ready for review property. :                                                                                                                                                                       João Messias                                11/01/2018                                                                                                        12  &lt;/div&gt;&lt;/section&gt;      Artigos:                                                                     Welcome to Jekyll!              :       You’ll find this post in your _posts directory. Go ahead and edit it and re-build the site to see your changes. You can rebuild the site in many different ways,. . . :                               20/11/2020        &lt;/span&gt;                                                                                                                                    Pedra de Roseta - 5 minutos de História              :       A série 5 minutos de história de hoje está imperdível! Vamos falar sobre um tesouro deixado pela civilização egípcia: a Pedra de Roseta. Embarque nessa viagem ao passado e descubra. . . :                                                                               João Messias                27/04/2020                                                                                                                                            Powerful things you can do with the Markdown editor              :       There are lots of powerful things you can do with the Markdown editor. If you’ve gotten pretty comfortable with writing in Markdown, then you may enjoy some more advanced tips. . . :                                                                               João Messias                12/06/2018                                                                                                                                            The first mass-produced book to deviate from a rectilinear format              :       The first mass-produced book to deviate from a rectilinear format, at least in the United States, is thought to be this 1863 edition of Red Riding Hood, cut into the. . . :                                                                               João Messias                12/06/2018                                                                                                                                            Education must also train one for quick, resolute and effective thinking.               :       There are lots of powerful things you can do with the Markdown editor:                                                                               João Messias                12/06/2018                                                                                                                                            Accumulated experience of social living              :       The die cut has also been employed in the non-juvenile sphere as well, a recent example being Jonathan Safran Foer’s ambitious Tree of Codes. :                                                                               João Messias                12/06/2018                                                                                                                                            About Bundler                         1 2 3 4 5                      :       gem install bundler installs the bundler gem through RubyGems. You only need to install it once - not every time you create a new Jekyll project. Here are some additional. . . :                                                                               João Messias                12/05/2018                                                                                                                                            We all wait for summer                         1 2 3 4 5                      :       As I engage in the so-called “bull sessions” around and about the school, I too often find that most college men have a misconception of the purpose of education. Most. . . :                                                                               João Messias                12/01/2018                                                                                                                                            Tree of Codes              :       The first mass-produced book to deviate from a rectilinear format, at least in the United States, is thought to be this 1863 edition of Red Riding Hood, cut into the. . . :                                                                               João Messias                12/01/2018                                               &laquo; Voltar       1        2      Avançar &raquo; "
    }, {
    "id": 5,
    ...
    "url": "/pagina/2/",
    "title": "Home",
    "body": "{% if page. url == “/” %} {% assign has_featured_posts = false %}{% for post in site. posts %}  {% if post. featured == true %}    {% assign has_featured_posts = true %}  {% endif %}{% endfor %} {% if has_featured_posts %}  &lt;section class= featured-posts &gt;    &lt;div class= section-title &gt;      &lt;h2&gt;Destaques&lt;/h2&gt;    &lt;/div&gt;    &lt;div class= row &gt; 123456789101112  {% for post in site. posts %}    {% if post. featured == true %}      {% include featuredbox. html %}    {% endif %}  {% endfor %}  &lt;/div&gt;&lt;/section&gt; {% endif %}{% endif %}       Artigos:         {% for post in paginator. posts %}    {% include postbox. html %}    {% endfor %}    {% include pagination. html %}"
    }, {
    "id": 14,
