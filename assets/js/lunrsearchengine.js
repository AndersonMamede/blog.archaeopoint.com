...
{% assign counter = 0 %}
{% assign search_only_post = 1 %}
var documents = [
    {% if search_only_post != 1 %}
    {% for page in site.pages %}
        {% if ignore_page or page.url contains '.xml' or page.url contains 'assets' or page.url contains 'category' or page.url contains 'tag' %}{% else %}{
            "id": {{ counter }},
